...
@section('content')
    <section id="profile-preview" class="pb-5">
        <div class="profile-banner">
            <img src="{{ $teacher->banner ? asset('storage/' . $teacher->banner) : asset('assets/img/mindly_bg.jpg') }}"
        ...
        <div class="container">
            ...
            <div class="row mt-4 reveal">
                <div class="col-md-8">
                    ...
                    <h4 class="text-danger mb-3">{{ $teacher->cities->name }} , {{ $teacher->cities->Governorates->name }}
                    </h4>
                    <p class="lead">{{ $teacher->description }}</p>
                    <div class="d-flex gap-3 mt-4">
                        <div class="star-rating">
                            @for ($i = 1; $i <= 5; $i++)
                                @if ($i <= $teacher->rating_system)
            ...
            <div class="row">
                <div class="col-12 mt-5">
                    ...
                    <div class="row g-4">
                        ...
                        @empty
                            <p class="text-white bg-danger text-center p-5">
                                {{ __('No courses available for this teacher.') }}</p>
                        @endforelse
                    </div>
                </div>
            </div>
