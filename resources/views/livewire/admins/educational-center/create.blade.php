              ...
              <div class="row">
                  ...
                  <div class="col-lg-8">
                      ...
                      <div class="row">
                          ...
                          <div class="col-lg-4">
                              <label for=""><i
                                      class="fa fa-phone"></i>{{ __('educational center phone') }}</label>
                              <input type="text" wire:model="phone" class="form-control w-100"
                                  placeholder="{{ __('Enter educational center phone') }}">
                          ...
                          <div class="col-lg-12">
                              ...
                              <textarea wire:model="address" name="" id="" cols="20" rows="2" class="form-control w-100"
                                  placeholder="{{ __('Enter educational center address') }}"></textarea>
                          </div>{{-- educational center address  & wire:model="address" --}}
                          <div class="col-lg-12">
                              <label for="">{{ __('Welcome Message') }}</label>
                              <textarea wire:model="welcome_message" name="" id="" cols="20" rows="2"
                                  class="form-control w-100" placeholder="{{ __('Enter welcome message') }}"></textarea>
                          </div>{{-- welcome message  & wire:model="welcome_message" --}}
                          <div class="col-lg-12">
                              <label for="">{{ __('About the educational center') }}</label>
                              <textarea wire:model="main_info" name="" id="" cols="10" rows="2" class="form-control w-100"
                                  placeholder="{{ __('Enter about the educational center') }}"></textarea>
                  ...
                  <div class="col-lg-4">
                      <div class="form-group">
                          <label for="image" class="btn">{{ __('Educational Center Image') }}
                              ...
                              @if ($logo)
                                  <img src="{{ $this->getPreviewUrl($logo) }}"
