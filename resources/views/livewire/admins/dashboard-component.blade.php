            ...
            <div class="card">
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                <p class="text-sm mb-0 text-uppercase font-weight-bold">{{ __('Today Total') }}</p>
            ...
            <div class="card">
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                <p class="text-sm mb-0 text-uppercase font-weight-bold">{{ __('Education Centers') }}</p>
                                <h3 class="font-weight-bolder">
                                    {{ $centers }}
                                </h3>
                                {{-- <p class="mb-0">
            ...
            <div class="card z-index-2 h-100">
                <div class="card-header pb-0 pt-3 bg-transparent">
                    ...
                    <p class="text-sm mb-0">
                        ...
                        <span class="font-weight-bold">4%</span> 2021
                    </p>
                </div>
                <div class="card-body p-3">
                    <div class="chart">
