                 ...
                 <div class="row p-2">
                     ...
                     <div class="col-md-12 mt-3">
                         ...
                         <div class="form-check form-switch text-center" dir="ltr">
                             <input class="form-check-input" type="checkbox" role="switch" id="toggle-isImage" wire:model.live="isImage" name="toggle-isImage">
                         ...
                         <div class="form-group">
                             <label for="image" class="btn">
                                 <input type="file" name="" id="image" wire:model="questionImage" hidden><br>
                                 @if ($questionImage)
                                 <img src="{{ $previewImage }}" style="width: 400px; height: 400px; object-fit: cover; border-radius: 10%;">
                                 @elseif($old_questionImage)
                                 <img src="{{ asset('storage/' . $old_questionImage) }}" style="width: 150px; height: 150px; object-fit: cover; border-radius: 50%;">
                                 @else
                                 <img src="{{ asset('assets/img/mindly_icon.png') }}" style="width: 400px; height: 400px; object-fit: cover; border-radius: 10%;">
                                 @endif
                             </label>
                             @error('image')
                             <span class="text-danger">{{ $message }}</span>
                     ...
                     <div class="col-md-12 mt-4">
                         ...
                         @error('questionAnswers.0.correct')
                         <span class="text-danger">{{ $message }}</span>
                         @enderror
                         @endif
                             ...
                             <div class="col-md-6">
                                 <div class="form-group">
                                     ...
                                     <div class="d-flex gap-3 mt-2">
                                         ...
                                         <input type="text" class="form-control" wire:model="questionAnswers.{{ $key }}.title">

                                         <label>
                                             <input type="radio" name="correct_answer" value="{{ $key }}" wire:model="correctAnswerIndex">
                                             <i class="fa-solid fa-check text-success"></i>
                                         </label>

                                     </div>
                                     <button type="button" class=" btn  border-0 text-danger" wire:click.prevent="removeQuestionAnswer({{ $key }})">
                     ...
                     <div class="col-md-12 mt-4">
                         ...
                         &nbsp;&nbsp;
                         <button wire:click.prevent="newQuestion()" type="submit" class="btn btn-info mt-3" {{ !$update ? 'hidden' : '' }}>
                             <i class="fa fa-plus"></i>
                         </button>
                         &nbsp;&nbsp;
                         <button wire:click.prevent="back('show-teacher-quizs',['teacher_id_create_quiz'],['questionTitle','questionType','answerScore','isImage'
                         ,'questionAnswers','correctAnswerIndex','old_questionImage','quizQuestions'])" class="btn btn-warning mt-3">
         ...
         <ol class="list-group list-group-numbered p-2">
             ...
             <li class="list-group-item d-flex justify-content-between align-items-start">
                 <div class="ms-2 me-auto">
                     ...
                     <button class="btn btn-success btn-sm" wire:click.prevent="editQuestion({{ $question->id }})">
                         <i class="fa-regular fa-edit"></i>
                     </button>
                     &nbsp;&nbsp;
                     <button class="btn btn-danger btn-sm" onclick="confirmDelete({{ $question->id }} ,'deleteQuestion')">
