        ...
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link {{ request()->is(app()->getLocale() . '/dashboard') ? 'active' : '' }}" href="{{ route('dashboard') }}">
                    <div class="icon icon-shape icon-sm border-radius-md text-center ms-1 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->is(app()->getLocale() . '/profile') ? 'active' : '' }}" href="{{ route('profile') }}">
                    <div class="icon icon-shape icon-sm border-radius-md text-center ms-1 d-flex align-items-center justify-content-center">
            ...
            {{-- Techer Management --}}
            <li class="nav-item">
                <a class="nav-link {{ request()->is(app()->getLocale() . '/teachers') ? 'active' : '' }}" href="{{ route('admins.teachers.index') }}">
                    <div class="icon icon-shape icon-sm border-radius-md text-center ms-1 d-flex align-items-center justify-content-center">
                ...
                <a class="nav-link {{ request()->is(app()->getLocale() . '/teacher-wallets') ? 'active' : '' }}" href="{{ route('admins.teacher-wallets.index') }}">
                    <div class="icon icon-shape icon-sm border-radius-md text-center ms-1 d-flex align-items-center justify-content-center">
                ...
                <a class="nav-link {{ request()->is(app()->getLocale() . '/teacher-courses') ? 'active' : '' }}" href="{{ route('admins.teacher-courses.index') }}">
                    <div class="icon icon-shape icon-sm border-radius-md text-center ms-1 d-flex align-items-center justify-content-center">
                ...
                <a class="nav-link {{ request()->is(app()->getLocale() . '/quiz') ? 'active' : '' }}" href="{{ route('admins.quiz.index') }}">
                    <div class="icon icon-shape icon-sm border-radius-md text-center ms-1 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->is(app()->getLocale() . '/educational-center') ? 'active' : '' }}" href="{{ route('admins.educationalCenters.index') }}">
                    <div class="icon icon-shape icon-sm border-radius-md text-center ms-1 d-flex align-items-center justify-content-center">
                ...
                <a class="nav-link {{ request()->is(app()->getLocale() . '/educational-center-wallets') ? 'active' : '' }}" href="{{ route('admins.educational-center-wallets.index') }}">
                    <div class="icon icon-shape icon-sm border-radius-md text-center ms-1 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->is(app()->getLocale() . '/code-list') ? 'active' : '' }}" href="{{ route('admins.code-list.index') }}">
                    <div class="icon icon-shape icon-sm border-radius-md text-center ms-1 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->is(app()->getLocale() . '/users') ? 'active' : '' }}" href="{{ route('admins.users.index') }}">
                    <div class="icon icon-shape icon-sm border-radius-md text-center ms-1 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->is(app()->getLocale() . '/countries') ? 'active' : '' }}" href="{{ route('admins.countries.index') }}">
                    <div class="icon icon-shape icon-sm border-radius-md text-center ms-1 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->is(app()->getLocale() . '/governorate') ? 'active' : '' }}" href="{{ route('admins.governorate.index') }}">
                    <div class="icon icon-shape icon-sm border-radius-md text-center ms-1 d-flex align-items-center justify-content-center">
                        <i class="fa-solid fa-earth-africa text-dark text-sm opacity-10"></i>
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->is(app()->getLocale() . '/cities') ? 'active' : '' }}" href="{{ route('admins.cities.index') }}">
                    <div class="icon icon-shape icon-sm border-radius-md text-center ms-1 d-flex align-items-center justify-content-center">
                        <i class="fa-solid fa-earth-africa text-dark text-sm opacity-10"></i>
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->is(app()->getLocale() . '/social-media-types') ? 'active' : '' }}" href="{{ route('admins.socialMediaTypes.index') }}">
                    <div class="icon icon-shape icon-sm border-radius-md text-center ms-1 d-flex align-items-center justify-content-center">
                        {{-- <i class="fa-solid fa-earth-africa text-dark text-sm opacity-10"></i> --}}
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->is(app()->getLocale() . '/content-types') ? 'active' : '' }}" href="{{ route('admins.contentTypes.index') }}">
                    <div class="icon icon-shape icon-sm border-radius-md text-center ms-1 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->is(app()->getLocale() . '/subjects') ? 'active' : '' }}" href="{{ route('admins.subjects.index') }}">
                    <div class="icon icon-shape icon-sm border-radius-md text-center ms-1 d-flex align-items-center justify-content-center">
                        <i class="fa-solid fa-lines-leaning text-dark text-sm opacity-10"></i>
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->is(app()->getLocale() . '/type-of-subscriptions') ? 'active' : '' }}" href="{{ route('admins.tos.index') }}">
                    <div class="icon icon-shape icon-sm border-radius-md text-center ms-1 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->is(app()->getLocale() . '/ads') ? 'active' : '' }}" href="{{ route('admins.ads.index') }}">
                    <div class="icon icon-shape icon-sm border-radius-md text-center ms-1 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->is(app()->getLocale() . '/TermsAndCondetions') ? 'active' : '' }}" href="{{ route('admins.termsAndCondetions.index') }}">
                    <div class="icon icon-shape icon-sm border-radius-md text-center ms-1 d-flex align-items-center justify-content-center">
            ...
            </li><!-- End Terms conditions -->
            <li class="nav-item">
                <a data-bs-toggle="collapse" href="#level-one" aria-expanded="false" aria-controls="level-one" class="nav-link">
                    <div class="icon icon-shape icon-sm border-radius-md text-center ms-1 d-flex align-items-center justify-content-center">
