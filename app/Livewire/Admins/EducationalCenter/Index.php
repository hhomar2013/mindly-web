...
class Index extends Component
{
    ...
    public $action             = 'index';
    public $banner             = null, $old_banner = null;
    public $isEdit             = false;
    ...
    public function save()
    {
        ...
        $banner = $this->banner ? $this->banner->store('centers', 'public') : null;
        if ($this->isEdit) {
            ...
            $center->update([
                ...
                'phone'           => $this->phone,
                'logo'            => $imageName ?? $this->old_logo,
                'panner'          => $banner ?? $this->old_banner,
